...
public:
    virtual void executar(const Matricula&) = 0;                 // M�todo por meio do qual � solicitado o servi�o.
    virtual void executar() = 0;
    virtual void setCntrServicoSessao(IServicoPeca *) = 0;         // M�todo para estabelecer liga��o (link) com a controladora de servi�o.
    virtual ~IApresentacaoSessao(){}                                          // M�todo destrutor virtual.
};
...
public:
    ...
    virtual ~IServicoSessao(){}                                         // M�todo destrutor virtual.
};
